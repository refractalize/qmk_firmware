...
uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [L_QWERTY] = LAYOUT(
        ...
        KC_LSFT           , KC_Z              , KC_X              , KC_C              , KC_V              , KC_B              , KC_MUTE           , KC_MPLY           , KC_N              , KC_M              , KC_COMM           , KC_DOT            , KC_SLSH           , KC_MINS           ,
                                                KC_LGUI           , KC_LALT           , KC_LCTL           , KC_SPC            , NAV_KEY           , SYM_KEY           , KC_LSFT           , KC_RCTL           , KC_RALT           , KC_RGUI
    ),
    ...
    [L_SYM] = LAYOUT(
        _______           , _______           , _______           , _______           , _______           , _______           ,                                         _______           , _______           , _______           , _______           , _______           , _______           ,
        _______           , KC_PERC           , KC_DLR            , KC_LCBR           , KC_RCBR           , KC_TILD           ,                                         KC_CIRC           , KC_LABK           , KC_RABK           , KC_PIPE           , KC_AMPR           , KC_DEL            ,
        _______           , KC_HASH           , KC_EQL            , KC_LPRN           , KC_RPRN           , KC_PLUS           ,                                         KC_EXLM           , KC_COLN           , KC_UNDS           , KC_DQUO           , KC_SCLN           , _______           ,
        _______           , KC_BSLS           , KC_SLSH           , KC_LBRC           , KC_RBRC           , KC_AT             , _______           , _______           , KC_QUES           , KC_ASTR           , KC_MINS           , KC_GRV            , _______           , _______           ,
                                                _______           , _______           , _______           , _______           , _______           , _______           , _______           , _______           , _______           , _______
    ),
    ...
    [L_NAV] = LAYOUT(
        ...
        _______           , KC_PSCR           , KC_LEFT           , KC_DOWN           , KC_RGHT           , KC_PGDN           ,                                         _______           , MT(MOD_LGUI, KC_B), MT(MOD_LALT, KC_W), MT(MOD_LCTL, KC_E), _______           , _______           ,
...
void update_layers(void) {
    ...
    // Apply logic: both down = NUM, otherwise individual layers
    if (nav_down && sym_down) {
        layer_on(L_NUM);
    } else {
        if (nav_down) layer_on(L_NAV);
        if (sym_down) layer_on(L_SYM);
    }
}
